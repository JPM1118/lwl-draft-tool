...
// playerRouter.get("/getskaters", async (req, res, next) => {
//   try {
...
//     let newPlayer = user.players[position].find(
//       (player) => player.PLAYER === name
//     );
//     const pickArray = await myPicks(req.user.userId);
//     const newPickIsMine = pickArray.some((myPick) => myPick === pick);
//     const totalPlayersSaved =
//       user.takenPlayers.skaters.length + user.takenPlayers.goalies.length;
...
//         const savedPlayerLastName = savedPlayer.PLAYER.substring(
//           savedPlayer.PLAYER.indexOf(" ")
//         );
