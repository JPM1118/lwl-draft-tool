...
const DraftTool = () => {
  ...
  const [takenPlayers, setTakenPlayers] = useState({ skaters: [], goalies: [] })
  ...
  return (
    <>
      {isLoading ? <Spinner marginTop={'20rem'} /> : <>
          ...
          <div>
            ...
            <div className={draftToolStyles.container}>
              <div className={draftToolStyles.myTeam}>
                <h3 className={draftToolStyles.myTeamTitle} onClick={() => setShowMyPlayers(true)}>MY TEAM</h3>
              ...
              <div className={draftToolStyles.availablePlayers}>
                <AvailablePlayers
                  ...
                  takenPlayers={isSkaters ? takenPlayers.skaters : takenPlayers.goalies}
                  isSkaters={isSkaters}
                />
              </div>
            </div>
            {showMyPlayers && <MyTeam myPlayers={isSkaters ? myPlayers.skaters : myPlayers.goalies} close={() => setShowMyPlayers(false)} />}
